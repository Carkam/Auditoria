...
function listar() {
    ...
    $.post(
        ...
        { usuario: usuario, accion: "Visualizó las tiendas" },
        function (f) {
...
function guardaryeditar(e) {
    ...
    $.post(
        "../ajax/bitacora.php?op=insertar",
        { usuario: usuario, accion: "Tienda Registrado o Actualizado" },
        function (f) {
        ...
        if (result) {
            $.post(
                ...
                function (e) {
                    ...
                    $.post(
                        "../ajax/bitacora.php?op=insertar",
                        { usuario: usuario, accion: "Desactivo Tienda: " + idtienda },
                        function (f) {
        ...
        if (result) {
            $.post(
                ...
                function (e) {
                    ...
                    $.post(
                        "../ajax/bitacora.php?op=insertar",
                        { usuario: usuario, accion: "Elimino Tienda: " + idtienda },
                        function (f) {
        ...
        if (result) {
            $.post(
                ...
                function (e) {
                    ...
                    $.post(
                        "../ajax/bitacora.php?op=insertar",
                        { usuario: usuario, accion: "Activo Tienda: " + idTienda },
                        function (f) {

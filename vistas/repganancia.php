              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                        <h1 class="box-title">Consulta de Ganancia por Fecha y Tienda</h1>
...
<script>
  $(document).ready(function(){
      $("#reporte").click(function(event){
        ...
        //if(tienda!=0){
          window.open("../reportes/repganancia.php?op=4&fechaini="+fechainicial+"&fechafinal="+fechafinal+"&tienda="+tienda+"&nombre="+tiendaname, '_blank'); 
          var usuario = $("#idusuario").val();
          $.post(
                              "../ajax/bitacora.php?op=insertar",
                              {usuario:usuario,accion:"Creó reporte de ganancias"}
                          );
        /*}else{
